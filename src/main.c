...
/*
 * $Id: main.c,v 1.31 2009/08/31 16:42:16 erik Exp $
 */
...
{
    printf ("\
%s (%s) Copyright (C) 2001-2009 Erik Greenwald <erik@smluc.org>\n\
...
main (int argc, char **argv)
{
    ...
    SDL_ShowCursor (0);
    SDL_WM_SetCaption ("glpong (C) 2001-2009 Erik Greenwald", "glpong");
