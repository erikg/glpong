...
/*
 * $Id: main.c,v 1.32 2010/01/06 01:06:00 erik Exp $
 */
...
{
    printf ("\
%s (%s) Copyright (C) 2001-2010 Erik Greenwald <erik@brlcad.org>\n\
...
main (int argc, char **argv)
{
    ...
    SDL_ShowCursor (0);
    SDL_WM_SetCaption ("glpong (C) 2001-2010 Erik Greenwald", "glpong");
